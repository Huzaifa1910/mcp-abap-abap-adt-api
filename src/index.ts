...
import { MigrationHandlers } from './handlers/MigrationHandlers.js';
...
export class AbapAdtServer extends Server {
  ...
  private objectRegistrationHandlers: ObjectRegistrationHandlers;
    ...
    private migrationHandlers: MigrationHandlers;
    ...
    this.migrationHandlers = new MigrationHandlers(this.adtClient);
      ...
      return {
        tools: [
          ...
          ...this.objectRegistrationHandlers.getTools(),
            ...
            ...this.migrationHandlers.getTools(),
            {
            name: 'healthcheck',
      ...
      try {
        ...
        switch (request.params.name) {
            ...
            case 'revisions':
                ...
                break;
            case 'migrationTargetStatus':
            case 'migrationLoginTarget':
            case 'migrationLogoutTarget':
            case 'exportObjectBundle':
            case 'importObjectBundle':
            case 'probeFormObject':
            case 'compareObjectSource':
            case 'discoverDependencies':
            case 'createTargetTransport':
            case 'transportInsertObject':
            case 'transportContents':
            case 'transportObjectRemove':
            case 'transportLogs':
            case 'transportObjectKeys':
            case 'tadirLookup':
            case 'packageContents':
            case 'whereUsedDeep':
            case 'adobeFormLayoutProbe':
            case 'transportImport':
                result = await this.migrationHandlers.handle(request.params.name, request.params.arguments);
                break;
            case 'healthcheck':
